...
/**
 * 用户和非用户的优惠券快照
 * Created by 史龙 on 2016/10/8.
 */
@Entity
@Table(name = "t_coupon_order")
public class CouponOrder extends BaseEntity{

    @Column(name = "name")
    private String name;//礼券名称

    @Column(name = "gain_way")
    private Integer gainWay;//获取方式：1-好友分享，2-订单完成后，3-注册后, 0-管理员赠送(补偿用)
